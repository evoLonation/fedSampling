...
if dataset == "mnist" :
	...
	if isiid:
		state_dict = torch.load("../saved_exp_info/final_model/CIFAR10_iid_0.01_random_any_i1000_N100_lr0.05_B50_d1.0_p0.1_m5_0.pth")
	else:
		state_dict = torch.load("../saved_exp_info/final_model/CIFAR10_nbal_0.01_random_any_i1000_N100_lr0.05_B50_d1.0_p0.1_m5_0.pth")
